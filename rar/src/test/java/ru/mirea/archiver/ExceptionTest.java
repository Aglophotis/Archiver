...
public class ExceptionTest {
    ...
    @Test
    public void emptyFileTwoTest() throws Exception {
        ...
        assertEquals(fileInputStream2.available(), 0);
    ...
    @Test
    public void emptyFileOneTest() throws Exception {
        Packer packer = new PackerImpl();
        Unpacker unpacker = new UnpackerImpl();
        Decryptor decryptor = new DecryptorImpl();
        Encryptor encryptor = new EncryptorImpl();
    ...
    @Test
    public void repeatSymblosTest() throws Exception {
        Packer packer = new PackerImpl();
        Unpacker unpacker = new UnpackerImpl();
        Decryptor decryptor = new DecryptorImpl();
        Encryptor encryptor = new EncryptorImpl();
        ...
        for (int i = 1; i < 50; i++){
            ...
            FileOutputStream fileOutputStream1 = new FileOutputStream(path1);
            FileOutputStream fileOutputStream2 = new FileOutputStream(path2);
            String tmp1 = generateStringRepeat(i*1000);
            String tmp2 = generateStringRepeat(i*2000);
    ...
    private String generateStringRepeat(int size){
